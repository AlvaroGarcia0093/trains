...
<body>
    <div class="container">
        ...
        <form action="{{ route('tickets.update', ['ticket'=>$ticket->id]) }}" method="POST">
            ...
            <input type="text" name="date" id="date" class="form-control" value="{{ $ticket->date }}">
            <label for="price" class="form-label">Precios</label>
            <input type="number" name="price" id="price" class="form-control" value="{{ $ticket->price }}">
